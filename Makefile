...
prod: disco/v1
	...
	aws --profile surf s3 cp disco/v1/discovery-$$(cat serial.txt).json.gz s3://eduroam-discovery/discovery/v1/discovery.json --cache-control "public, max-age=3600, stale-while-revalidate=604800" --content-encoding gzip
